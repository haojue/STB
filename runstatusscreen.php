...
function loadXMLDoc()
{
	...
	if (window.XMLHttpRequest)
	 ...
	 <?php exec("sudo rm -f $_REQUEST[log]")?>;
         ...
         <?php #exec("sudo mv -f $_REQUEST[log] screen_testresults")?>;
...
list($tclserver, $tclname, $chassisip, $cardname, $port, $dstmac) = explode(",",$param);  

echo "$tclname running on server $tclserver with chassis ip $chassisip, card $cardname, port $port";
