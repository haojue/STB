...
$users = get_users();
echo "firefox browser recommended";
echo "<br>";
echo "current users:";
...
echo "<br>";
echo "<br>";
#echo "If you want to create an account, please contact haojue@juniper.net";
	  /******************** ERROR MESSAGES*************************************************
        ...
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr> 
            <td colspan="2"> <div align="center"> 
                ...
                <p><a href="reguser.php">Register Free</a><font color="#FF6600"> 
                  |</font> <a href="chpasswd.php">Change Password</a> <font color="#FF6600"> 
                  |</font> <a href="forgetpass.php">Forgot Password</a> <font color="#FF6600"> 
                  </font></p>
