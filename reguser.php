...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="main">
  ...
  <tr> 
    ...
    <td width="732" valign="top"><p>&nbsp;</p>
      <h3 class="titlehdr">Register User 
      </h3> 
	  <p>
<?php
	  /******************** ERROR MESSAGES*************************************************
	  ...
	  **************************************************************************/
      ...
      <form action="auth.php" method="post" name="logForm" id="logForm" >
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr> 
            <td>Password</td>
            <td><input name="pwd1" type="password" class="required password" id="txtbox" size="25"></td>
          </tr>
          <tr> 
            <td>Retype Password</td>
            <td><input name="pwd2" type="password" class="required password" id="txtbox" size="25"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2"> <div align="center"> 
                <p> 
                  <input name="doLogin" type="submit" id="doLogin3" value="Register">
                </p>
