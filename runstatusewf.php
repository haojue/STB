...
list($tclname,$tclserver,$chassisip,$sustaintime, $cardname, $startport,$endport) = explode(",",$param);

echo "$tclname running on server $tclserver with chassis ip $chassisip, card $cardname, port $startport and $endport";
